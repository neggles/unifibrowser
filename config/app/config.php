...
$controllers = [
    [
        'user'     => getenv('UNIFI_USER'), // the username for access to the Unifi Controller
        'password' => getenv('UNIFI_PASS'), // the password for access to the Unifi Controller
        'url'      => 'https://' . getenv('UNIFI_HOST') . ':' . getenv('UNIFI_PORT'), // full url to the Unifi Controller, eg. 'https://22.22.11.11:8443'
        'name'     => getenv('UNIFI_NAME') // name for this controller which will be used in the dropdown menu
    ],
];
 ...
 */
$theme           = getenv('APP_THEME'); // your default theme of choice, pick one from the list below:
                                // bootstrap, cerulean, cosmo, cyborg, darkly, flatly, journal, lumen, paper
                                // readable, sandstone, simplex, slate, spacelab, superhero, united, yeti

$navbar_class    = getenv('APP_NB_CLASS');      // class for the main navigation bar, valid options are: light, dark
$navbar_bg_class = getenv('APP_NB_COLOR');      // class for the main navigation bar background, valid options are:
